<?php
    ...
    $reg_no=$message=$file=$file_loc=$final_file=$file_exists="";
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST"){
        ...
        $new_file_name=strtolower($reg_no."-PPT");
        $final_file=str_replace(' ','-',$new_file_name);
        if(move_uploaded_file($file_loc,$folder.$final_file)){ 
            $sql="UPDATE student_credentials SET ppt='$final_file' WHERE reg_no='$reg_no'";
        ...
        if($count==0){
            ...
            while($count>0){
                    ...
                    if($row["ppt"]==NULL){
                        ...
                        echo "<a href='./uploads/ppt/".$row["ppt"]."' target='_blank'>".$row["ppt"]."</a>";
                    }
                    $count=$count-1;
                }
        }
